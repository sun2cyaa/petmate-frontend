...
export default function PetMateSignupPage() {
  ...
  // 로그인 사용자 정보 로드 (JWT 헤더 방식, CORS cookies 불사용)
  useEffect(() => {
    (async () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      // 헤더 JWT 자동 주입, 쿠키 미사용. withCredentials 전달 금지.
      await apiRequest.post("/user/petmate/apply", fd, {
        headers: { /* FormData는 브라우저가 boundary 자동 지정 */ },
        silent: false,
      });
